        ...
        case (nid1 #:: rest1, nid2 #:: rest2) =>
          (recorded.nodes(nid1), replayed.nodes(nid2)) match {
            case (
                ...
                if coid1 === coid2 && coinst1 === coinst2 &&
                  signatories1 == signatories2 && stakeholders1 == stakeholders2 && key1 === key2 =>
            ...
            case (
                ...
                if coid1 === coid2 && templateId1 == templateId2 &&
                  actingParties1.forall(_ => actingParties1 == actingParties2) &&
                  signatories1 == signatories2 && stakeholders1 == stakeholders2 &&
                  key1.forall(_ => key1 == key2) =>
              loop(rest1, rest2, stack)
            case (
              ...
              // Exercise result are check after having checking the children
              if (targetCoid1 === targetCoid2 && templateId1 == templateId2 && choiceId1 == choiceId2 &&
                consuming1 == consuming2 && actingParties1 == actingParties2 && chosenValue1 === chosenValue2 &&
                stakeholders1 == stakeholders2 && signatories1 == signatories2 && choiceObservers1 == choiceObservers2 &&
                controllersDifferFromActors1 == controllersDifferFromActors2 &&
                exerciseResult1.fold(true)(_ => exerciseResult1 === exerciseResult2) &&
                key1.fold(true)(_ => key1 === key2)) {
                loop(
            ...
            case (
                ...
                ) if templateId1 == templateId2 && key1 === key2 && result1 === result2 =>
              loop(rest1, rest2, stack)
            case _ => fail(Some(nid1), Some(nid2))
          }

        case (Stream.Empty, Stream.Empty) =>
          stack match {
            case (nid1, exe1, nids1, nid2, exe2, nids2) :: rest =>
              if (exe1.exerciseResult === exe2.exerciseResult)
