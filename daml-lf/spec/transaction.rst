...
the *dev* version is used as staging area for the next stable transaction
version. The "dev" version can be changed freely without compatibility
considerations to prior "dev" versions.
